...
// Prisma's enum types are string unions with the same values as the client
// enums, so a string-keyed lookup is safe here.
const amenityIcons: Record<string, LucideIcon> = AmenityIcons;
const highlightIcons: Record<string, LucideIcon> = HighlightIcons;
